...
print("🌱 Création des données permanentes...")

# Organisateur
try:
    org = User.objects.get(username='organisateur_main')
    print("  ⏭️  Organisateur déjà existant")
except User.DoesNotExist:
    org = User(
        username='organisateur_main',
    ...
    org.save()
    print("  ✅ Organisateur créé")

# Participant
try:
    part = User.objects.get(username='participant_main')
    print("  ⏭️  Participant déjà existant")
except User.DoesNotExist:
    part = User(
        username='participant_main',
    ...
    part.save()
    print("  ✅ Participant créé")

EVENTS = [
    {
        'title'      : "TechTalk Dakar — L'IA en Afrique 2025",
        'description': "Conférence incontournable sur l'IA en Afrique.\nKeynotes, tables rondes, networking et ateliers pratiques.",
    ...
    },
    {
        ...
        'description': "La plus grande nuit afrobeats de l'année ! Artistes locaux et internationaux.",
    ...
    },
    {
        ...
        'description': 'Apprenez le Design Thinking utilisé par les plus grandes entreprises mondiales.',
        'location'   : 'CTIC Dakar, Almadies',
    ...
    },
    {
        ...
        'description': 'Parcours 5km, 10km et 21km ouverts à tous les niveaux !',
    ...
    },
    {
        ...
        'location'   : 'Sofitel Dakar Terrou-Bi',
    ...
    },
    {
        ...
        'description': 'Forum dédié aux femmes leaders africaines qui transforment leurs secteurs.',
    ...
    },
    {
        ...
        'description': '48h pour imaginer les solutions fintech de demain. Prix total : 5 millions FCFA.',
        'location'   : 'Orange Digital Center, Dakar',
